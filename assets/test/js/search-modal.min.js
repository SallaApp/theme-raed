...
`;export class SearchModal extends HTMLElement{connectedCallback(){this.append(template.content.cloneNode(!0))}init(){return{results:[],showModal:!1,fetchStatus:'',showResult:!1,searchTerm:'',animatItems:function(){var a=document.querySelectorAll('.anime-item');anime({targets:a,opacity:[0,1],translateY:[30,0],delay:function(b,a){return a*75}})},openSearch:function(a){this.searchTerm='',this.fetchStatus='',this.results=[],this.showModal=!0,window.scrollTo(0,0),document.getElementsByTagName('html')[0].style.position="fixed",document.getElementsByTagName('html')[0].style.overflowY="scroll",this.$nextTick(()=>{this.$refs.searchInput.focus()}),this.animatItems()},closeSearch:function(a){this.searchTerm='',this.fetchStatus='',this.results=[],document.getElementsByTagName('html')[0].style.position="static",document.getElementsByTagName('html')[0].style.overflowY="auto",this.showModal=!1},search:function(){this.fetchStatus='loading',this.showResult=!1,this.results=[],fetch("http://www.omdbapi.com/?&apikey=e1a73560&s="+this.searchTerm+"&type=movie").then(a=>a.json()).then(a=>{this.fetchStatus='idle',this.results=a.Search,this.showResult=!0,this.results.length<1&&(this.fetchStatus='error')}).catch(a=>{this.showResult=!0,this.fetchStatus='error',console.log(a)})}}}}customElements.define('search-modal',SearchModal)