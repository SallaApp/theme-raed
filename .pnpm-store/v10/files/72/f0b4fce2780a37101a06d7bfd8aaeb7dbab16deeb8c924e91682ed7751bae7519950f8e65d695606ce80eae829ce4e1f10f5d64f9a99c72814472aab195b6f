...
export class SallaOrderTotalsCard {
    ...
    static get originalStyleUrls() {
        return {
            "$": ["salla-order-totals-card.scss"]
        };
    }
    static get styleUrls() {
        return {
            "$": ["salla-order-totals-card.css"]
        };
    }
        ...
        return {
            "order": {
                ...
                "complexType": {
                    ...
                    "resolved": "Order | string",
                    "references": {
                        "Order": {
                            "location": "import",
                            "path": "../salla-orders/interface",
                            "id": "src/components/salla-orders/interface.ts::Order"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Order summary object. Accepts a JSON string or object containing the order totals."
                },
                "getter": false,
                "setter": false,
                "reflect": false
