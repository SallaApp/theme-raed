...
class App extends AppHelpers {
  ...
  injectMaintenanceAlert() {
    ...
    style.innerHTML = `.store-notify{display:flex;align-items:center;justify-content:center;flex-direction:row;width:100%;min-height:40px;position:fixed;top:0;right:0;left:0;padding:5px 30px 5px 60px;z-index:3500}
            ...
            .maintenance-alert .store-alert-content .btn-store-alert:hover{background:#35cbb5}.maintenance-alert .store-alert-content .btn-store-alert .visible-xs {display: none;}
            @media only screen and (max-width:767px){.store-notify{padding:5px 10px 5px 60px}.store-notify p{line-height:1.2}.maintenance-alert .store-alert-content{flex-direction:row;padding:0}
